...
pyinstaller --onefile --hidden-import=_sysconfigdata__linux_x86_64-linux-gnu --collect-all pysam --name msmutect --hidden-import=tempfile --hidden-import=json --hidden-import=ctypes --hidden-import=platform \
